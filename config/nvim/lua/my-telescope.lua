...
-- mappings
-- why the grep_string is super slow...
...
--     opt
-- )
vim.api.nvim_set_keymap("n", "<Leader>fa", [[<Cmd>lua require('telescope.builtin').live_grep()<CR>]], opt)
...
vim.api.nvim_set_keymap("n", "<Leader>ft", [[<Cmd>lua require('telescope.builtin').help_tags()<CR>]], opt)
